...
if (isset($_POST['park_action']) && $_POST['park_action'] == 'add') {
	...
	$stmt2 -> bindValue(1, $_POST["park_name"], PDO::PARAM_STR);
	$stmt2 -> bindValue(2, $_POST["park_description"], PDO::PARAM_STR);
	$stmt2 -> bindValue(3, $_POST["park_location"], PDO::PARAM_STR);
	$stmt2 -> execute();
